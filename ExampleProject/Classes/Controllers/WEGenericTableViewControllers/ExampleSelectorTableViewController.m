//
//  ExampleSelectorTableViewController.m
//  ExampleProject
//
...
- (void) viewDidLoad
{
	self.title = @"WEGenericTableView";
}

- (void)constructTableGroups
{
	
	WEMultilineLabelCellController *_descriptionCellController = [[[WEMultilineLabelCellController alloc] initWithText:@"Please select one of the following example. They all demonstrate some different feature of the WEGenericTableView library."] autorelease];	
